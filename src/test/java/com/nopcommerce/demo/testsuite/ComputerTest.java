...
public class ComputerTest extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        checkOutPage.sendDataToFirstNameField("manish");
        checkOutPage.sendDataToLastNameField("patel");

        Random random = new Random();
        checkOutPage.sendDataToEmailField("manish"+random.nextInt()+"@gmail.com");

        checkOutPage.selectCountryFromDropDown("United Kingdom");
        checkOutPage.sendDataToCityField("london");
        checkOutPage.sendDataToAddressField("28, tagor Road");
        checkOutPage.sendDataToPostCodeField("ha3 7fe");
        ...
        checkOutPage.sendDataToCardholderNameField("manish");
        checkOutPage.sendDataToCardNumberField("5555555555554444");
        checkOutPage.sendDataToExpiryDateField("04");
        checkOutPage.sendDataToExpiryYearField("2022");
        checkOutPage.sendDataToCardCodeField("023");

...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        registerPage.sendDataToFirstNameField("manish");
        registerPage.sendDataToLastNameField("patel");

        Random random = new Random();
        String tempEmail = "manish"+random.nextInt()+"@gmail.com";
        registerPage.sendDataToEmailField(tempEmail);

        registerPage.sendDataToPasswordField("abcd345");
        registerPage.sendDataToConfirmPasswordField("abcd345");
        ...
        checkOutPage.sendDataToCardNumberField("4111111111862258");
